    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl p-6 border border-gray-100">
                ...
                <form action="{{ route('diaries.store') }}" method="POST" class="space-y-4" onsubmit="showLoadingForm(this)" enctype="multipart/form-data">
                    @csrf 
