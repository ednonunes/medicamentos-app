...
<div class="flex flex-col sm:flex-row gap-4 mt-4">
    <div class="flex-1">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Intervalo (h)</label>
        <input type="number" name="interval_hours" min="1" value="{{ old('interval_hours', $medication->interval_hours ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
    </div>
