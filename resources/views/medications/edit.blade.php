    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <form action="{{ route('medications.update', $medication->id) }}" method="POST" class="space-y-4">
                    @csrf 
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-900 rounded-md shadow-sm transition duration-150">Atualizar Alterações</button>
                    </div>
                </form>
